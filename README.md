...
This file contains the qualitative analysis data from participant observation in a meeting with 21 practitioners and 9 reporters (n=9) that share your experience.
